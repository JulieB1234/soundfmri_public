function timing_files_audibPerSNR_unc2_nosave(sub_nb, options)
...
%% december 2025
% re used for unconscious processing -> stim not heard (con1) and no stim
% (con2)

%% SET UP DIRECTORIES AND OUTPUT FILES

Output_directory = '/Volumes/DisqueJulie/JulieBoyer2025/SOUNDFMRI 2025/uniV_ActiveHnotH_v2/timing_files';
